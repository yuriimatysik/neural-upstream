...
"${CXX:-g++}" -shared -std=c++20 -O2 -DNDEBUG \
  ...
  -o nvngx.dll.addon64 src/addon.cpp \
...
echo "built: $(ls -la nvngx.dll.addon64 | awk '{print $5}') bytes"
