...
for test_source in tests/submission_tracker.cpp tests/descriptor_lifetime.cpp tests/feature_registry.cpp tests/control_state.cpp tests/guide_metadata.cpp; do
